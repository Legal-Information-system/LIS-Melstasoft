...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container mw-100 my-4">
        <div class="row justify-content-center">
            ...
            <div class="card o-hidden border-0 shadow-lg p-0" style="padding-left: unset; padding-right: unset; width: 1000px">
                    ...
                    <form class="user" action="">
                        ...
                        <div class="row mb-2 mt-4 ">
                            <div class="d-flex justify-content-start ">
                                ...
                                <asp:Button ID="btnReset" runat="server" Text="Reset" CssClass="btn btn-primary btn-user btn-block m-2" BackColor="#212529" BorderColor="#212529" />
